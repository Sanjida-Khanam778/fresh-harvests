...
export default function Products() {
  ...
  const products = [
    { id: 1, name: "Mushroom", price: "$2.3/kg", image: "/forest-floor-mushrooms.png" },
    { id: 2, name: "Mustard", price: "$1.3/kg", image: "/mustard-leaves.jpg" },
    { id: 3, name: "Orange", price: "$4.2/kg", image: "/orange-citrus.jpg" },
    { id: 4, name: "Pomegranate", price: "$11.2/kg", image: "/ripe-pomegranate.png" },
    ...
    { id: 8, name: "Eggplant", price: "$1.2/kg", image: "/single-ripe-eggplant.png" },
  ]
    ...
    <section className="w-full py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-green-600 font-semibold mb-2">Our Products</p>
          ...
          {categories.map((category) => (
            <button
              ...
              className={`px-6 py-2 rounded font-medium transition-colors ${
                activeCategory === category ? "bg-green-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {products.map((product) => (
            <div key={product.id} className="bg-gray-50 rounded-lg p-6 text-center hover:shadow-lg transition-shadow">
              ...
              {/* Add to Cart Button */}
              <button className="w-full py-2 px-4 bg-gray-300 text-gray-700 rounded font-medium transition-colors hover:bg-orange-500 hover:text-white">
                Add to cart
              </button>
            </div>
          ))}
